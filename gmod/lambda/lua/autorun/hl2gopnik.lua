...
local GAMETYPE = {}
GAMETYPE.Name = "Half-Life 2: Gopnik"
...
function GAMETYPE:LoadCurrentMapScript()
    self.Base.LoadMapScript(self, "hl2gopnik", game.GetMap():lower())
end
...
hook.Add("LambdaLoadGameTypes", "HL2GopnikGameType", function(gametypes)
    gametypes:Add("hl2gopnik", GAMETYPE)
end)